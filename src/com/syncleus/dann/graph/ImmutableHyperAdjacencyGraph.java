...
public class ImmutableHyperAdjacencyGraph<N, E extends HyperEdge<N>> extends AbstractHyperAdjacencyGraph<N,E>
{
	...
	@Override
	public ImmutableHyperAdjacencyGraph<N,E> cloneAdd(E newEdge)
	{
		return (ImmutableHyperAdjacencyGraph<N,E>) super.cloneAdd(newEdge);
	}

	@Override
	public ImmutableHyperAdjacencyGraph<N,E> cloneAdd(N newNode)
	{
		return (ImmutableHyperAdjacencyGraph<N,E>) super.cloneAdd(newNode);
	}

	@Override
	public ImmutableHyperAdjacencyGraph<N,E> cloneAdd(Set<N> newNodes, Set<E> newEdges)
	{
		return (ImmutableHyperAdjacencyGraph<N,E>) super.cloneAdd(newNodes, newEdges);
	}

	@Override
	public ImmutableHyperAdjacencyGraph<N,E> cloneRemove(E edgeToRemove)
	{
		return (ImmutableHyperAdjacencyGraph<N,E>) super.cloneRemove(edgeToRemove);
	}

	@Override
	public ImmutableHyperAdjacencyGraph<N,E> cloneRemove(N nodeToRemove)
	{
		return (ImmutableHyperAdjacencyGraph<N,E>) super.cloneRemove(nodeToRemove);
	}

	@Override
	public ImmutableHyperAdjacencyGraph<N,E> cloneRemove(Set<N> deleteNodes, Set<E> deleteEdges)
	{
