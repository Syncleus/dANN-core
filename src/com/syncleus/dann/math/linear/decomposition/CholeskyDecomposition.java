 ...
 */
public class CholeskyDecomposition<M extends Matrix<M, F>, F extends OrderedAlgebraic<F>> implements java.io.Serializable, SolvableDecomposition<M>
{
	 ...
	 */
	public CholeskyDecomposition(M matrix)
	{
		// Initialize.
		M newMatrix = matrix;
