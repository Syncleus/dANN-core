...
public class MutableBayesianAdjacencyNetwork<N extends BayesianNode, E extends BayesianEdge<N>> extends AbstractBayesianAdjacencyNetwork<N,E> implements MutableBayesianNetwork<N,E>
{
	...
	@Override
	public MutableBayesianAdjacencyNetwork<N,E> cloneAdd(E newEdge)
	{
		return (MutableBayesianAdjacencyNetwork<N,E>) super.cloneAdd(newEdge);
	}

	@Override
	public MutableBayesianAdjacencyNetwork<N,E> cloneAdd(N newNode)
	{
		return (MutableBayesianAdjacencyNetwork<N,E>) super.cloneAdd(newNode);
	}

	@Override
	public MutableBayesianAdjacencyNetwork<N,E> cloneAdd(Set<N> newNodes, Set<E> newEdges)
	{
		return (MutableBayesianAdjacencyNetwork<N,E>) super.cloneAdd(newNodes, newEdges);
	}

	@Override
	public MutableBayesianAdjacencyNetwork<N,E> cloneRemove(E edgeToRemove)
	{
		return (MutableBayesianAdjacencyNetwork<N,E>) super.cloneRemove(edgeToRemove);
	}

	@Override
	public MutableBayesianAdjacencyNetwork<N,E> cloneRemove(N nodeToRemove)
	{
		return (MutableBayesianAdjacencyNetwork<N,E>) super.cloneRemove(nodeToRemove);
	}

	@Override
	public MutableBayesianAdjacencyNetwork<N,E> cloneRemove(Set<N> deleteNodes, Set<E> deleteEdges)
	{
