...
public class TestSimpleBayesianNetwork
{
	...
	//create nodes
	private BayesianNode season = new SimpleBayesianNode(SeasonState.WINTER, network);
	private BayesianNode age = new SimpleBayesianNode(AgeState.BABY, network);
	private BayesianNode stuffyNose = new SimpleBayesianNode(BooleanState.TRUE, network);
	private BayesianNode fever = new SimpleBayesianNode(FeverState.HOT, network);
	private BayesianNode tired = new SimpleBayesianNode(BooleanState.FALSE, network);
	private BayesianNode sick = new SimpleBayesianNode(BooleanState.FALSE, network);
	...
	public void testOverall()
	{
		...
		Assert.assertTrue("incorrect fever to sickness mapping!", (nonePercentage < lowPercentage) && (lowPercentage < warmPercentage) && (warmPercentage < hotPercentage) );
	}
