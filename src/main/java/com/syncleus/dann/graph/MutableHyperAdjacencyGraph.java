...
public class MutableHyperAdjacencyGraph<N, E extends Hyperedge<N>> extends AbstractHypergraph<N, E> implements MutableHypergraph<N, E>
{
	...
	public MutableHyperAdjacencyGraph(final CloudGraph<N, E> copyGraph)
	{
		super(copyGraph);
	}
