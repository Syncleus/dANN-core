...
public class SimplePath<N, E extends Cloud<N>> extends AbstractPath<N, E>
{
	...
	public SimplePath(final List<E> ourSteps, final List<N> ourNodeSteps, final double defaultWeight)
	{
	...
	public SimplePath(final List<E> ourSteps, final List<N> ourNodeSteps)
	{
