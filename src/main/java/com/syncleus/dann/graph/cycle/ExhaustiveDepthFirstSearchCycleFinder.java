...
public class ExhaustiveDepthFirstSearchCycleFinder<N, E extends TraversableEdge<N>> extends ColoredDepthFirstSearchDetector implements CycleFinder<N, E>
{
	@Override
	...
	private static <N, E extends TraversableEdge<N>> void cyclesFromStart(final Graph<N, E> graph, final Set<N> untouchedNodes, final Set<Cycle<N, E>> cycles, final N startNode)
	{
	...
	private static <N, E extends TraversableEdge<N>> List<N> neighborsFromEdge(final E edge, final N sourceNode)
	{
	...
	private static <N, E extends TraversableEdge<N>> void traverse(final Graph<N, E> graph, final Set<N> untouchedNodes, final Set<Cycle<N, E>> cycles, final Stack<N> parentNodes, final Stack<E> parentEdges, final E lastEdge, final N currentNode)
	{
	...
	private static class CycleLengthComparator<N, E extends TraversableEdge<N>> implements Comparator<Cycle<N, E>>, Serializable
	{
