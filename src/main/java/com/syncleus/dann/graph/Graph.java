 ...
 */
public interface Graph<N, E extends TraversableCloud<? extends TraversableCloud.Endpoint<N>>> extends Serializable, Cloneable, XmlSerializable<GraphXml, Object>, ContextReporter
{
	/**
